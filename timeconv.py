...
def tg():
    ...
    if cm.get()==cm['values'][0]:
        if sc1.get()!="" and sc2.get()=="":
            a=str(int(sc1.get())*52)
            sc2.set(a)
        elif sc1.get()=="" and sc2.get()!="":
            a=str(int(sc2.get())/52)
            sc1.set(a)

    elif cm.get()==cm['values'][1]:
        if sc1.get() != "" and sc2.get() == "":
            a=str(int(sc1.get())*365)
            sc2.set(a)
        elif sc1.get() == "" and sc2.get() != "":
            a = str(int(sc2.get())/365)
            sc1.set(a)

    elif cm.get() == cm['values'][2]:
        if sc1.get() != "" and sc2.get() == "":
            a=str(int(sc1.get())*24)
            sc2.set(a)
        elif sc1.get() == "" and sc2.get() != "":
            a = str(int(sc2.get())/24)
            sc1.set(a)
...
cm['values']=("(1)Year <-> (2)Week", "(1)Year <-> (2)Day", "(1)Day <-> (2)Hour", "select any one")
cm.current(3)
cm.place(x=200, y=30)
